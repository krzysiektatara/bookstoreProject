...
namespace BookStoreApplicationAPI.Data
{
    public static class SeedData
    {
        ...
        public static async Task AddTestData(BookStoreDbContext context)
        {
            ...
            await context.Database.ExecuteSqlRawAsync("DELETE FROM dbo.role");
            ...
            await context.Database.ExecuteSqlRawAsync($"INSERT INTO bookings (user_id, product_id, delivery_address, delivery_date, delivery_time, status_id, quantity)\r\nVALUES \r\n  ({usersIds[5]}, {productsIds[2]}, 'Address 1', '2023-02-10', '10:00:00', 1, 2),\r\n  ({usersIds[1]}, {productsIds[1]}, 'Address 2', '2023-02-11', '11:00:00', 1, 3),\r\n  ({usersIds[5]}, {productsIds[0]}, 'Address 3', '2023-02-12', '12:00:00', 1, 4),\r\n  ({usersIds[2]}, {productsIds[3]}, 'Address 4', '2023-02-13', '13:00:00', 1, 5),\r\n  ({usersIds[0]}, {productsIds[3]}, 'Address 5', '2023-02-14', '14:00:00', 1, 6);");

            await context.Database.ExecuteSqlRawAsync($"INSERT INTO book_store (product_id, available_qty, booked_qty, sold_qty)\r\nVALUES \r\n  ({productsIds[0]}, 10, 4, 2),\r\n  ({productsIds[1]}, 12, 3, 5),\r\n  ({productsIds[2]}, 3, 2, 0),\r\n  ({productsIds[3]}, 6, 11, 9),\r\n  ({productsIds[4]}, 4, 0, 0);");
